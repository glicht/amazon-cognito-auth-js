**Note:** This is a fork configured to work with a test Cognito User Pool. And fully available for testing at: <https://rawgit.com/guylichtman/amazon-cognito-auth-js/master/sample/index.html>
